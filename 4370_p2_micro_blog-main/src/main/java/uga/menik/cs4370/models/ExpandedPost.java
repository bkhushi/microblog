...
/**
 * Represents a post in its expanded form within the micro blogging platform. An
 * ExpandedPost includes comments.
 */
public class ExpandedPost extends Post {
    ...
    /**
     * Constructs an ExpandedPost with specified details including a list of
     * comments.
     *
     ...
     * @param isHearted indicates whether the post is hearted by the current
     * user
     * @param isBookmarked indicates whether the post is bookmarked by the
     * current user
    ...
    public ExpandedPost(String postId, String content, String postDate, User user, int heartsCount, int commentsCount, boolean isHearted, boolean isBookmarked, List<Comment> comments) {
        ...
        System.out.println("ExpandedPost created: " + this);

    }

    /**
     * Returns an unmodifiable view of the comments list, to prevent external
     * modifications.
     *
    ...
    public String toString() {
        return "ExpandedPost{id=" + getPostId() + ", content='" + getContent() + "}";
    }
